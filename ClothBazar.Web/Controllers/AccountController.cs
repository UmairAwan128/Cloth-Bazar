...
namespace ClothBazar.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        { //added two properties in RegisterViewModel as we need to get Name and Address from user while Registration
            if (ModelState.IsValid)
            {
                //as we need to get Name and Address from user while Registration
                //and save it in DB so additionally added two properties in ApplicationUser  
